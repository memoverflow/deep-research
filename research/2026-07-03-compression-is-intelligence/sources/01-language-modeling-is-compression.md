...
Key facts:
- Chinchilla 70B compresses ImageNet patches to 43.4% of raw size (vs PNG 58.5%)
- Chinchilla 70B compresses LibriSpeech audio to 16.4% of raw size (vs FLAC 30.3%)
- Prediction-compression equivalence: any compressor can become a generative model
- Provides new lens on scaling laws, tokenization, in-context learning
